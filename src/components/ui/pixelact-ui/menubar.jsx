...
export const menubarVariants = cva("shadow-(--pixel-box-shadow) box-shadow-margin", {
  variants: {
    font: {
      normal: "",
      pixel: "pixel-font",
...
const Menubar = React.forwardRef(({ className, font, ...props }, ref) => (
...
const MenubarSubContent = React.forwardRef(({ className, font, ...props }, ref) => (
      ...
      <MenubarPrimitive.ItemIndicator>
        <svg
          ...
          <rect
            ...
            height="14"
            rx="1"
            transform="rotate(90 80 128)"></rect>
          <rect
            x="96"
            y="144"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 96 144)"></rect>
          <rect
            x="112"
            y="160"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 112 160)"></rect>
          <rect
            x="128"
            y="144"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 128 144)"></rect>
          <rect
            x="144"
            y="128"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 144 128)"></rect>
          <rect
            x="160"
            y="112"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 160 112)"></rect>
          <rect
            x="176"
            y="96"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 176 96)"></rect>
          <rect
            x="192"
            y="80"
            width="14"
            height="14"
            rx="1"
            transform="rotate(90 192 80)"></rect>
        </svg>
      </MenubarPrimitive.ItemIndicator>
    </span>
    {children}
