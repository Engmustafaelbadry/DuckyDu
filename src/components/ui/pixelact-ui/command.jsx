...
function CommandEmpty({
  ...
  return (<ShadcnCommandEmpty data-slot="command-empty" className="py-6 text-center text-sm" {...props} />);
}
...
function CommandShortcut({
  ...
  return (<ShadcnCommandShortcut className={cn("", "retro", className)} {...props} />);
}
